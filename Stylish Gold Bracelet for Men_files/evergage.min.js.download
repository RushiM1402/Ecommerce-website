...
Evergage.init({            
    cookieDomain: 'tanishq.co.in'             
}).then(() => {              
                  
    if (window.location.hostname === 'www.tanishq.co.in') {
        console.log("26");   
        let customerId = "";           
        let customerName = "";                                                
                    ...
                    if (result && result["customerId"]) {
                                    ...
                                    Evergage.sendEvent(
                                        {
                                            ...
                                            user:
                                            {
                                                attributes: { userName: customerName, firstName: result["firstName"] }
                                            }
                                        }
                                    );
                                }
                        ...
                        if (result && result["emailHash"] && result["emailHash"] !== "N/A") {
                            if (emailLocalStg === null || emailLocalStg !== result["emailHash"]) {
                                ...
                                // console.log("Email Encrypted:" + encryptedEmailAddress);
                                Evergage.sendEvent(
                                    {
                        ...
                        if (result && result["mobileNumber"] && result["mobileNumber"] !== "N/A") {
                            if (mobileLocalStg === null || mobileLocalStg !== result["mobileNumber"]) {
                                ...
                                //  console.log("Mobile Number Encrypted:" + encryptedMobileNumber);
                                Evergage.sendEvent(
                                    {
        ...
        const config = {
            global: {
                onActionEvent: (actionEvent) => {
                    ...
                    // if(evgloginStatus || !evgloginStatus ){
                    //     actionEvent.user.attributes.loginStatus = evgloginStatus;
                    // }
            ...
            pageTypes: [
                {
                                ...
                                if (window.dataLayer && window.dataLayer.length > 3) {
                                    ...
                                    for (let i = 0; i < lengthDataLayer; i++) {
                                        ...
                                        if (dataLayerObj.currentPageView && dataLayerObj.currentPageView === "HomePageView") {
                                            console.log("On HomePage", currentChecks);
                                            resolve(true);
                    ...
                    contentZones: [
                        ...
                        //{ name: "HeroBanner[Slot-5]", selector: ".evgFigHerobanner5" },
                          { name: "Top Seller", selector: ".evgTopSeller" },  
                        { name: "Shop By Category", selector: ".evgShopbyCategory" },
                         { name: "Similar Items Section", selector: "#evgSimilarItemsContainer" }, 
                        ...
                        return new Promise((resolve, reject) => {
                            ...
                            let prodCheckInterval = window.setInterval(function () {
                                ...
                                if (window.dataLayer && window.dataLayer.length > 3) {
                                    let matched = false;
                                    let lengthDataLayer = 0;
                                    //var test = Object.keys(window.dataLayer).length;
                                    //console.log(test);  
                                   //console.log(window.dataLayer);
                                    ...
                                    //console.log(window.dataLayer[5]);
                                    //var testda = window.dataLayer;
                                    //console.log(":Length ", lengthDataLayer);
                                    for (let i = 0; i < lengthDataLayer; i++) {
                                        const dataLayerObj = window.dataLayer[i];
                                        //console.log(dataLayerObj.currentPageView);
                                  ...
                                  if (window.dataLayer && window.dataLayer.length > 5) { 
                                      ...
                                      for (let i = 0; i < lengthDataLayer; i++) {
                                          ...
                                          if (dataLayerObj.currentPageView && dataLayerObj.currentPageView === "OrderConfirmationView") {
                                              console.log("On OrderConfirmation");
                                              getOrderItems();
                                              resolve(true);
                                              matched = true;
                                              break;
            ...
            if (window.dataLayer) {
                for (let k = 0; k < window.dataLayer.length; k++) {
                    ...
                    if (resOrder && resOrder["Items"] && resOrder["Items"].length >= 1) {
                        ...
                        // console.log("Array Products", arrOrderItems);
